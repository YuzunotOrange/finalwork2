...
result_dir = "result_PPS_lorenz_noise"
...
def generate_lorenz_noisy(n_steps=10000, r=4.0, x0=0.3, discard=1000, noise_ratio=0.05):
    x = generate_lorenz(n_steps=n_steps, r=r, x0=x0, discard=discard)
...
datasets = {
    ...
    "Lorenz+noise (Chaos)": generate_lorenz_noisy(),
