...
tau = min(tau, auto_max_lag)


#伊藤法
E1_i = itho_e1_e2(x, max_dim = args.max_dim, tau = tau, s = tau, k=int(0.05*len(x)), theiler=tau)
...
print("tau:", tau, "k:", int(0.05*len(x)))
print("E1_i:", np.array2string(E1_i, precision=3))
